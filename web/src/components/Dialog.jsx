...
const styles = {
  ...
  icon: {
    ...
    fontSize: 20, fontWeight: 700, marginBottom: 14, flexShrink: 0,
  },
  title: { fontSize: 16, fontWeight: 700, color: 'var(--text-primary)', marginBottom: 2 },
  message: { fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.55, marginBottom: 22 },
