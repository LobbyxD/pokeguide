...
export default function MapEditor({ mapData, gameId, onClose, onSave }) {
  ...
  // Reset connection inputs whenever a different area is selected
  useEffect(() => { setConnInputs({}) }, [selectedAreaId])
        ...
        <div style={styles.body}>
          ...
          <div style={styles.main}>
            ...
            <div style={styles.canvas} ref={canvasRef} onMouseMove={handleSVGMouseMove} onMouseUp={handleSVGMouseUp}>
              ...
              <div style={styles.kbOverlay}>
                <div style={styles.kbOverlayRow}><kbd style={styles.kbKey}>V</kbd><span>Select</span></div>
                <div style={styles.kbOverlayRow}><kbd style={styles.kbKey}>R</kbd><span>Draw rect</span></div>
                <div style={styles.kbOverlayRow}><kbd style={styles.kbKey}>H</kbd><span>Pan</span></div>
                <div style={styles.kbOverlayRow}><kbd style={styles.kbKey}>+</kbd><kbd style={styles.kbKey}>−</kbd><span>Zoom</span></div>
                <div style={styles.kbOverlayRow}><kbd style={styles.kbKey}>0</kbd><span>Reset view</span></div>
                <div style={styles.kbOverlayRow}><kbd style={styles.kbKey}>Ctrl Z</kbd><span>Undo</span></div>
                <div style={styles.kbOverlayRow}><kbd style={styles.kbKey}>Shift</kbd><span>+draw merge</span></div>
                <div style={styles.kbOverlayRow}><kbd style={styles.kbKey}>Del</kbd><span>Delete area</span></div>
              </div>
            </div>
                    ...
                    <div style={styles.pokemonList}>
                      {(selectedArea.pokemon || []).map(p => (
                        <div key={p} style={styles.pokemonRow}>
                          ...
                          />
                          <span style={styles.pokemonRowName}>{capitalize(p)}</span>
